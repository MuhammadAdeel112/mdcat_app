...
//   // Replace with your admin's number, include country code without '+'
//   final String adminNumber = '923190560129'; // e.g., Pakistan +92

//   // Function to launch WhatsApp
//   void openWhatsApp(String number) async {
//     final url = Uri.parse("https://wa.me/$number"); // WhatsApp link
...
//               onPressed: () => openWhatsApp(adminNumber),
...
//   // Admin number in international format without '+'
//   final String adminNumber = '923154522003'; // e.g., Pakistan +92
...
class ChatScreen extends StatelessWidget {
  ...
  // Future<void> openWhatsApp(BuildContext context, String number) async {
  //   final whatsappUrl = Uri.parse("whatsapp://send?phone=$number&text=Hello");
